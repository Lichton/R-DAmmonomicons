...
namespace ETGClasses
{
    public static class EnemyBuilder
    {
        ...
        public static void SetupEntry(this AIActor enemy, string shortDesc, string longDesc, string portrait, string AmmonomiconSprite, string EnemyName)
        {
            ...
            Module.Strings.Enemies.Set("#" + EnemyName.ToUpper(), EnemyName);
            Module.Strings.Enemies.Set("#" + shortDesc.ToUpper(), shortDesc);
            Module.Strings.Enemies.Set("#" + longDesc.ToUpper(), longDesc);
